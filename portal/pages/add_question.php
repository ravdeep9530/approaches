...
<div class="row">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Stream Wise</a>
                                        </h4>
                                    </div>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class=" panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" id="detail_form" action="submit_question.php" method="post">
                            <fieldset>
		...
		<optgroup label="--Basic/UG Qualification--" class="red"></optgroup>		
				...
				<option value="DD^PPG">Other Doctorate Degree</option>		
                                ...
                                <label>Question:</label>
                                    <input class="form-control" placeholder="" id="Q"  name="Q" type="text"  value="">
