...
<h3 class="h1" style="text-align: center; color: #202020; display: block; font-family: Arial; font-size: 24px; font-weight: bold; line-height: 100%; margin-top: 0; margin-right: 0; margin-bottom: 10px; margin-left: 0;">Paid following amount to get full Access.</h3> <?php
					include("../connection.php");
$hex=$_GET['hex'];		
$rate=$_GET["rate"];			$query="SELECT * FROM  people WHERE hex='$hex'";
if($rate==200){
$rate=200;
}else if($rate==500)
{
...
Dear <strong> <?php echo $name;?> </strong><p>Thank you for upgrading your Approach Account.</p>
...
<table border="0" width="0" align="right">
  ...
  <tr>
    <td align="right"><br/>
   <b> Voucher Pack:</b>&nbsp;&nbsp;&nbsp; <?php echo $rate; ?>
   <br/>
   <b> Service Tax:</b>&nbsp;&nbsp;&nbsp; 15%
    </td>
  </tr>
  ...
  <tr>
    <td align="right">
     <b> Grand Total:</b>&nbsp;&nbsp;&nbsp; <?php echo $rate+$gt;?>/-
    </td>
  </tr>
  ...
  <tr>
    <td align="center">
    <b> Total Payable:</b>&nbsp;&nbsp;&nbsp; <?php echo $rate+$gt;?>/- Rupees Only
    </td>
  </tr>
...
<div style="color: #707070; font-family: Arial; font-size: 12px; line-height: 125%; text-align: center;"><button style="background-color:#9C3; color:#FFF; width:100%; padding:2%;" onClick="location.href='instamojo/index.php?rate=<?php echo $rate+$gt;?>&name=<?php echo $name;?>&email=<?php echo $email;?>&hex=<?php echo $hex;?>'">Pay Now</button></div></td>
</tr>
</tbody>
</table>
</td>
